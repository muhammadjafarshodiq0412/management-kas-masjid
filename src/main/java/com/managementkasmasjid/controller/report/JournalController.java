...
public class JournalController {
    ...
    public String showDownloadDocument(@ModelAttribute("data") DownloadFileRequest request, Model model) {
        List<GlobalParam> params = globalParamService.getAllByCondition(GlobalConstant.CATEGORY_JOURNAL);
        model.addAttribute("params", params);
        return "pages/report/journal/index";
    }

    @PostMapping("/view-report")
    public String viewReport(@ModelAttribute("data") DownloadFileRequest request, Model model) {
        GlobalParam param = globalParamService.getByParamConditionAndParamDesc(GlobalConstant.CATEGORY_JOURNAL, request.getCategory().getParamDesc());
        List<Journal> data = journalService.getAllCategoryJournal(param,request);
        ...
        return "pages/report/journal/view";
    }
